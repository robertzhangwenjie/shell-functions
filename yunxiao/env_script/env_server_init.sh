...
# @LastEditTime: 2020-08-26 23:46:22
...
get_env_script() {
  echo "下载:${ENV_SCRIPT}"
  wget -nv -P ${HOME} ${ENV_SCRIPT_DOWNLOAD_URL}/${ENV_SCRIPT_ADDRESS}
}
...
install_env_script() {
  ...
  /bin/cp -rf /root/$ENV_SCRIPT /home/$username/
  unzip -o -d /home/$username /home/$username/$ENV_SCRIPT
